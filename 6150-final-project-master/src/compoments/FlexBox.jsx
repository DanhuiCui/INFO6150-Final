  ...
  return (
    <Row className="Row1">
      <Col xs={24} sm={24} md={8} lg={8} xl={8}><div className="d1" >
        ...
        <button className="bt1"><Link to="/Sell"  className="l1">Buy</Link></button>
      </div>
      </Col>
      <Col xs={24} sm={24} md={8} lg={8} xl={8}>
        ...
        <button className="bt1"><Link to="/Rent"  className="l1">Sell</Link></button>
        </div>
      </Col>
      <Col xs={24} sm={24} md={8} lg={8} xl={8}>
        <div className="d1">
        ...
        <button className="bt1"><Link to="/Buy" className="l1">Rent</Link></button>
        </div>
      </Col>
    </Row>);
}
